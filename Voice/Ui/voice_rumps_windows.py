...
class VoiceTrayIcon(QSystemTrayIcon):
    ...
    def __init__(self, parent=None):
        ...
        # 状态显示（自定义）
        self.status_action = QAction("● 服务状态: 已停止", self.menu)
        ...
        # 控制菜单
        self.start_action = QAction("▶ 启动API服务", self.menu)
        self.start_action.triggered.connect(self.start_api)
        self.menu.addAction(self.start_action)
        
        self.stop_action = QAction("⏹ 停止API服务", self.menu)
    ...
    def start_recorder(self):
        ...
        if self.recorder is None and self.api_running:
            try:
                from Voice.voice import VoiceRecorder
